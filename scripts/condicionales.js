...
ejercicio = prompt("introduzca el numero de lo ejercicio: (1, 2, 3, 4)")
 switch (ejercicio) {
    case 1:
        <script src="../scripts/condicionales-ej1.js"></script>
       break;
      case 2:
        <script src="../scripts/condicionales-ej2.js"></script>
          break;
      case 3:
         <script src="../scripts/condicionales-ej3.js"></script>
         break;
     case 4:
          <script src="../scripts/condicionales-ej4.js"></script>
         break;
    default:
         console.log("Eso no es un número aceptable");
       break;
